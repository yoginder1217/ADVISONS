...
router.post("/", async (req, res) => {
    ...
    if (schema.validate(req.body.password)) {
        ...
        res.status(400).send({ result: "Fail", message: "Invalid Password!!! Password Length Must Be on Minimum 8 and Maximum 100 also include 1 upper case character, 1 lower case character and not include any space" })
    }
})
    ...
    try{
        ...
        if(data){
            ...
            let mailOption = {
                ...
                to:data.email,
                subject:"OTP for PASSWORD RESET!!! : Team Advisions",
