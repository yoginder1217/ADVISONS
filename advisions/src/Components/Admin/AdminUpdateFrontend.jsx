...
export default function AdminUpdateFrontend() {
  ...
  const postData = (e) => {
    ...
    dispatch(updateFrontend({data:formData,_id: _id}))
  ...
  const getAPIData = useCallback(() => {
    ...
    if (allfrontends.length) {
      const item = allfrontends.find((x) => x._id === _id)
      if (item) {
        setData((old) => {
          return {
            ...old,
            ...
            <div className=''>
              <form onSubmit={postData}>
                ...
                <div className="mb-3">
                  ...
                  <textarea name="des" rows="5" value={data.des} required onChange={getInputData} className='form-control'></textarea>
                </div>
                <div className="mb-3">
