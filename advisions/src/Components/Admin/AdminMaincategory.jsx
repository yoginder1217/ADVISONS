...
export default function AdminMaincategory() {
  ...
  useEffect(() => {
    ...
    getAPIData();
  }, [dispatch, allmaincategories.length, allmaincategories]);
  return (
    <>
      {/* <!-- Hero Start --> */}
      ...
      <div className="contain-fluid my-5">
        <div className="row">
          ...
          <div className="col-md-9 col-12">
            <h5 className='bg-primary text-center p-2'>Maincategories <Link to="/admin-add-maincategory" className='text-dark'><span className="fa fa-plus float-end"></span></Link></h5>
